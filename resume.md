...
- **[cloud-mcp-server / AWS CLI MCP](https://github.com/alexei-led/aws-mcp-server)** (Python, **182★**) — MCP server exposing AWS CLI workflows to Claude, Cursor, and other MCP clients with scoped credentials, container isolation, streamable HTTP transport, and MCP-native errors.
- **[ccgram](https://github.com/alexei-led/ccgram)** (Python, **165★**) — Telegram ↔ tmux control plane for AI coding agents including Claude Code, Codex CLI, and Gemini CLI; supports remote monitoring, prompts, and parallel sessions.
- **[cc-thingz](https://github.com/alexei-led/cc-thingz)** — Plugin suite for Claude Code, Codex, Pi, and Gemini; packages skills, agents, hooks, and cross-target build tooling for agentic software development.
...
- **[Pumba](https://github.com/alexei-led/pumba)** (Go, **3K+★**) — Chaos engineering for containers: network emulation, fault injection, and stress testing across Docker, Podman, and containerd.
- **Cloud-native OSS:** [KubeIP](https://github.com/doitintl/kubeip) (**447★**) for static Kubernetes node IPs; [Secrets-Init](https://github.com/doitintl/secrets-init) (**172★**) for AWS/GCP secret injection; [Spotinfo](https://github.com/alexei-led/spotinfo) (**161★**) for AWS Spot inventory and pricing.
...
- **Engineering:** Go, Python, TypeScript, Shell, SaaS platforms, distributed systems, microservices, event-driven systems, platform engineering, modular architecture
- **DevOps / Leadership:** Terraform, GitHub Actions, CI/CD, IAM, secure sandboxed execution, distributed teams, hiring, mentoring, architecture governance, customer advisory

### Education, Certifications & Patents

- **Education:** M.Sc. Computer Science, Tel Aviv University (2006–2007); B.Sc. Computer Science & Statistics, Tel Aviv University (1992–1996)
